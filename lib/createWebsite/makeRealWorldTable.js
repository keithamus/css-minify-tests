...
const minifyAllRealWorldTests = async function () {
  ...
  for (const minifier of minifiers) {
    for (const library of libraries) {
      ...
      const end = Date.now();
      library.duration[minifier] = end - start;
      if (error) {
