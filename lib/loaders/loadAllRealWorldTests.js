 ...
 * @property {object} [results]    Minifier keys will be added with their result lengths
 * @property {object} [duration]   Minifier keys will be added with their result times
 *
 * @example
 * {
